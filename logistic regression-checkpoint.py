   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<matplotlib.collections.PathCollection at 0x13a5decb490>"
      ]
     },
     "execution_count": 3,
     "metadata": {},
